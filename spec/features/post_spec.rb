...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it "has a scope so that only post creators can see their posts" do
      ...
      other_user = User.create(first_name: "Non", last_name: "Authorized", email: "nonauth@test.com", password: "testing", password_confirmation: "testing")
  ...
  describe 'edit' do
    before do
      @edit_user = User.create(first_name: "testuser", last_name: "testuser", email: "testuser@test.com", password: "testing", password_confirmation: "testing")
